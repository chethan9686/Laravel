...
class CreateMumbaiAttendencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mumbai_attendences', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('mumbai_attendences', function (Blueprint $table){
    ...
    {
        Schema::dropIfExists('mumbai_attendences');
    }
}
