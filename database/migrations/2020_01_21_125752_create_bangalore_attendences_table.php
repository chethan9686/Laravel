...
class CreateBangaloreAttendencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bangalore_attendences', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('bangalore_attendences', function (Blueprint $table){
    ...
    {
        Schema::dropIfExists('bangalore_attendences');
    }
}
