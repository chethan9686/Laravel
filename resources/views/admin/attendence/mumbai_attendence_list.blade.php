...
<title>HRM | Mumbai Attendance</title>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Mumbai {{$today->format('F')}} Attendance List</h2>
                    <ul class="breadcrumb">
                    ...
                    <div class="card">  
                        <div class="header" style="padding-top: 0px;">
                            ...
                            @if(!is_null($LastMonth))
                                <a href="{{route('admin.previous_mumbai_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$LastMonth}} Attendance</button></a>
                            @else
                                <a href="{{route('admin.mumbai_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$Current->format('F')}} Attendance</button></a>
                            @endif
                        </div>   
                        <div class="body">
