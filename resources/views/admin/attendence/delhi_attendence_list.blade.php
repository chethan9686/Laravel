...
<title>HRM | Delhi Attendance</title>
                    ...
                    <div class="card">
                        <div class="header" style="padding-top: 0px;">
                            ...
                            @if(!is_null($LastMonth))
                                <a href="{{route('admin.previous_delhi_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$LastMonth}} Attendance</button></a>
                            @else
                                <a href="{{route('admin.delhi_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$Current->format('F')}} Attendance</button></a>
                            @endif
                        </div>                           
                        <div class="body">
