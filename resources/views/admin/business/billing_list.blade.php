                                        ...
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable" data-page-length='250'>
                                            ...
                                            <tbody>
                                                ...
                                                @php                                       
                                                    ...
                                                    $revision = \App\UserBusinessRevion::where('biilling_id',$List->id)->where('status',2)->orderBy('updated_at','Desc')->first();    
                                                @endphp
                                                <tr>
                                                    <td>{{ $key+1 }}</td>    
                                                    ...
                                                    <td><button class="btn btn-round btn-danger Signup" data-id="{{ $List->signup_id }}">View</button></td>                              
                                                    <th>
                                                        @if($List->level == 0)
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <button class="btn btn-round btn-danger Billing" data-id="{{ $List->id }}">View</button>     
                                                        @endif
                                                    </td>  
                                                    @if($User->id == 1)
                                                        @if($List->level == 0)
                                                        ...
                                                        @elseif($List->level == 3)
                                                        <td>
                                                            <a class="btn btn-success " data-toggle="modal" data-target="#approveModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}" data-revision="{{$revision['status']}}"><i class="zmdi zmdi-check" style="color:#fff"></i></a>
                                                            <a class="btn btn-danger " data-toggle="modal" data-target="#rejectModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}"><i class="zmdi zmdi-close" style="color:#fff"></i></a>
                                                        </td> 
                                                        @elseif($List->level == 4)
                                                        <td>
                                                            <span class="btn btn-round btn-danger">Redo</span>
                                                    ...
                                                    @elseif($User->id == 2)
                                                        ...
                                                        @elseif($List->level == 6)
                                                        <td>
                                                            <a class="badge badge-success " href="javascript:void(0)" data-toggle="modal" data-target="#approveModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}" data-revision="{{$revision['status']}}"><i class="zmdi zmdi-check" style="color:#fff;font-size: 17px"></i></a>
                                                            <a class="badge badge-warning " href="javascript:void(0)" data-toggle="modal" data-target="#rejectModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}"><i class="zmdi zmdi-redo" style="color:#fff;font-size: 17px"></i></a>
                                                            <a class="badge badge-danger " href="javascript:void(0)" data-toggle="modal" data-target="#cancelModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}"><i class="zmdi zmdi-delete" style="color:#fff;font-size: 17px"></i></a>
                                                        </td>
                                                        @elseif($List->level == 7)
                                                        <td>
                                                            <span class="btn btn-round btn-danger">Redo</span>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @elseif($User->id == 2)
                                                        ...
                                                        <td>
                                                            <a class="badge badge-success " href="javascript:void(0)" data-toggle="modal" data-target="#approveModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}" data-revision="{{$revision['status']}}"><i class="zmdi zmdi-check" style="color:#fff;font-size: 17px"></i></a>
                                                            <a class="badge badge-waring " href="javascript:void(0)" data-toggle="modal" data-target="#rejectModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}"><i class="zmdi zmdi-redo" style="color:#fff;font-size: 17px"></i></a>
                                                            <a class="badge badge-danger " href="javascript:void(0)" data-toggle="modal" data-target="#cancelModal" data-id="{{$List->id}}" data-heading="{{$List->bs_number}}" data-user_id="{{$User->id}}"><i class="zmdi zmdi-delete" style="color:#fff;font-size: 17px"></i></a>
                                                        </td>
                                                        @elseif($List->level == 7)
                                                        <td>
...
<div class="modal fade" id="viewbillinglist" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg viewbilling" role="document">
...
<div class="modal fade" id="approveModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
           ...
           <form method="post" action="{{route('admin.approve_billing')}}"  enctype="multipart/form-data" id="billingapprove">
            @csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
           ...
           <form method="post" action="{{route('admin.reject_billing')}}" enctype="multipart/form-data" id="billingredo">
            @csrf
            <input type="hidden" name="list_id" id="list_id" value="">
            <input type="hidden" name="user_id" id="user_id" value="">
                <div class="modal-body"> 
...
<div class="modal fade" id="cancelModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
           ...
           <form method="post" action="{{route('admin.cancel_billing')}}" enctype="multipart/form-data" id="billingcancel">
            @csrf
            <input type="hidden" name="list_id" id="list_id" value="">
            <input type="hidden" name="user_id" id="user_id" value="">
                <div class="modal-body"> 
...
<script>
    ...
    $(document).on('click', '.Billing', function (e) {
        ...
        $.ajax({
            url: '{{ route('admin.view_billing_list') }}',
            type: "POST",
            dataType: "json",
            data: {"_token": "{{ csrf_token() }}","id" : id},
            success: function (data) 
                    {
                      $(".viewbilling").html(data);                 
                      $('#viewbillinglist').modal('show');           
                    }
            })         
    }); 
    ...
    $("#billingredo").on("submit", function(){
     ...
     $("#billingcancel").on("submit", function(){
        $("#pageloader").fadeIn();
    });//submit
</script>
@endsection