                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane in active" id="ban">
                                    <div class="header">
                                        <h2>Export <strong>Bangalore</strong> Dismantle </h2>
                                    </div>  
                                   <div class="table-responsive">                                    
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            ...
                                            <tbody> 
                                               @foreach($Bang_Dismental as $key=>$data)
                                                    @php
                                ...
                                <div role="tabpanel" class="tab-pane" id="mum">
                                    <div class="header">
                                        <h2>Export <strong>Mumbai</strong> Dismantle </h2>
                                    </div>  
                                  <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            <thead>
                                            ...
                                            <tbody> 
                                               @foreach($Mum_Dismental as $key=>$data)
                                                    @php
                                                        $user = \App\User::find($data->user_id);
                                                        $branch = \App\Branch::find($data->branch);
                                                    @endphp
                                ...
                                <div role="tabpanel" class="tab-pane" id="del">
                                    <div class="header">
                                        <h2>Export <strong>Delhi</strong> Dismantle </h2>
                                    </div>   
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            <thead>
                                            ...
                                            <tbody> 
                                               @foreach($Del_Dismental as $key=>$data)
                                                    @php
                                                        $user = \App\User::find($data->user_id);
                                                        $branch = \App\Branch::find($data->branch);
                                                    @endphp
                                ...
                                <div role="tabpanel" class="tab-pane" id="hyd">
                                   <div class="header">
                                        <h2>Export <strong>HYDERABAD</strong> Dismantle </h2>
                                    </div>   
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            <thead>
                                            ...
                                            <tbody> 
                                               @foreach($Hyd_Dismental as $key=>$data)
                                                    @php
                                                        $user = \App\User::find($data->user_id);
                                                        $branch = \App\Branch::find($data->branch);
                                                    @endphp
