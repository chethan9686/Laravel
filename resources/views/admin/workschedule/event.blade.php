                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane in active" id="ban">
                                    <div class="header">
                                        <h2>Export <strong>Bangalore</strong> Event</h2>
                                    </div>  
                                   <div class="table-responsive">                                    
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            ...
                                            <tbody> 
                                               @foreach($Bang_Event as $key=>$data)
                                                    @php
                                ...
                                <div role="tabpanel" class="tab-pane" id="mum">
                                    <div class="header">
                                        <h2>Export <strong>Mumbai</strong> Event</h2>
                                    </div>  
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            <thead>
                                ...
                                <div role="tabpanel" class="tab-pane" id="del">
                                    <div class="header">
                                        <h2>Export <strong>Delhi</strong> Event</h2>
                                    </div>   
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            <thead>
                                ...
                                <div role="tabpanel" class="tab-pane" id="hyd">
                                   <div class="header">
                                        <h2>Export <strong>HYDERABAD</strong> Event</h2>
                                    </div>   
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                            <thead>
