<script type="text/javascript">
    ...
    {
         var user_id = <?php echo json_encode(\Illuminate\Support\Facades\Request::segment(3)); ?>; 
         ...
         {   
          $.ajax({
           url:"{{ URL(env('ADMIN_PREFIX').'/admin-academics-data') }}",  
           ...
           success:function(data)
           {
            ...
            $('.admin_education_table').html(html);
           }
          });
         }
         ...
         $(document).on('click', '#add', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.add_academic_data') }}",
            method:"POST",
            data:{course_name:course_name, from:from,to:to,university:university,location:location,branch:branch,percentage:percentage,class_obt:class_obt,user_id:user_id, _token:_token},
            success:function(data)
            {
             $('#admin_message').html(data);
             fetch_academic_data();
            }
           });
          }
          ...
          {    
           $('#admin_message').html("<div class='alert alert-danger'>All Fields are required</div>");
          }
         });
         ...
         $(document).on('blur', '.column_name', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.update_academic_data') }}",
            method:"POST",
          ...
          {
           $('#admin_message').html("<div class='alert alert-danger'>Enter some value</div>");
          }
         });
         ...
         $(document).on('click', '.delete', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.delete_academic_data') }}",
            method:"POST",
         ...
         {   
          $.ajax({
           url:"{{ URL(env('ADMIN_PREFIX').'/admin-employment-data') }}",
           data:{user_id:user_id, _token:_token},   
           dataType:"json",
           success:function(data)
           {
            ...
            $('.admin_employment_table').html(html);
           }
          });
         }
         ...
         $(document).on('click', '#emp_add', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.add_employment_data') }}",
            method:"POST",
            data:{duration_from:duration_from, duration_to:duration_to,duration_month:duration_month,organization:organization,designation:designation,role:role,leaving:leaving,user_id:user_id,_token:_token},
            success:function(data)
            {
             $('#admin_emp_message').html(data);
             fetch_employment_data();
            }
           });
          }
          ...
          {    
           $('#admin_emp_message').html("<div class='alert alert-danger'>All Employment Details Fields are required</div>");
          }
         });
         ...
         $(document).on('blur', '.employment_name', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.update_employment_data') }}",
            method:"POST",
            data:{column_name:column_name, column_value:column_value, id:id, _token:_token},
            success:function(data)
            {
          ...
          {
           $('#admin_emp_message').html("<div class='alert alert-danger'>Enter some value</div>");
          }
         });
         ...
         $(document).on('click', '.emp_delete', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.delete_employment_data') }}",
            method:"POST",
            data:{id:id, _token:_token},
            success:function(data)
            {
         ...
         {   
          $.ajax({
           url:"{{ URL(env('ADMIN_PREFIX').'/admin-family-data') }}",
           data:{user_id:user_id, _token:_token},   
           dataType:"json",
           success:function(data)
           {
         ...
         $(document).on('click', '#family_add', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.add_family_data') }}",
            method:"POST",
            data:{relationship:relationship, name:name,age:age,dependent:dependent,user_id:user_id,_token:_token},
            success:function(data)
            {
             $('#admin_family_message').html(data);
             fetch_family_data();
            }
           });
          }
          ...
          {    
           $('#admin_family_message').html("<div class='alert alert-danger'>All Family Details Fields are required</div>");
          }
         });
         ...
         $(document).on('blur', '.family_name', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.update_family_data') }}",
            method:"POST",
            data:{column_name:column_name, column_value:column_value, id:id, _token:_token},
            success:function(data)
            {
          ...
          {
           $('#admin_family_message').html("<div class='alert alert-danger'>Enter some value</div>");
          }
         });
         ...
         $(document).on('click', '.family_delete', function(){
          ...
          {
           $.ajax({
            url:"{{ route('admin.delete_family_data') }}",
            method:"POST",
            data:{id:id, _token:_token},
            success:function(data)
            {
