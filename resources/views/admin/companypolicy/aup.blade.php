        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>ACCEPTABLE USAGE POLICY (AUP)</h2>
                    <ul class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card pricing pricing-item">
                        ...
                        <div class="body text-body" style="background: #fff;">
                            ...
                            <p style="text-align: left;font-weight: bold;"><span style="color:#be533b;font-weight:bold;border-bottom:1px solid black;">Bjorn Waring</span></p>
                           <!-- <p style="text-align: left;font-weight: bold;">Designation : <span style="color:#be533b;font-weight:bold;border-bottom:1px solid black;">COO</span></p>-->
                        </div>
                    </div>
                </div>
            </div>
