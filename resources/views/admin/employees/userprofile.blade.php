                                    ...
                                    <div class="container-fluid">
                                        <div class="row clearfix">                                 
                                            ...
                                            <div class="col-lg-10 col-md-10">                                               
                                                <form method="post" action="{{route('admin.update_basic_details')}}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4">
                                                            ...
                                                            <div class="form-group">                                                   
                                                               <select class="form-control show-tick ms select2" data-placeholder="Select" name="team_lead">
                                                        ...
                                                        <div class="col-lg-4 col-md-4">
                                                            ...
                                                            <div class="form-group">                                                       
                                                                <select class="form-control show-tick ms select2" data-placeholder="Select" name="reporting_manager">
                                                        ...
                                                        <div class="col-lg-4 col-md-4">
                                                            ...
                                                            <div class="form-group">                                                       
                                                                <select class="form-control show-tick ms select2" data-placeholder="Select" name="regional_head">
                                            ...
                                            <div class="col-lg-10 col-md-10">                                                                             
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <form method="post" action="{{route('admin.update_passport_details')}}" enctype="multipart/form-data">
                                                            @csrf         
                                                            <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                           
                                                                <div class="card">                                                           
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <form method="post" action="{{route('admin.update_bank_details')}}" enctype="multipart/form-data">
                                                            @csrf       
                                                            <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                 
                                                                <div class="card">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row clearfix"> 
                                            ...
                                            <div class="col-lg-10 col-md-10">
                                                ...
                                                <form method="post" action="{{route('admin.update_pf_form')}}" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="row clearfix">                                                                                                                   
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <table id="mainTable" class="table table-striped c_table">
                                                        ...
                                                        <tbody class="admin_education_table">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <table id="mainTable1" class="table table-striped c_table">
                                                        ...
                                                        <tbody class="admin_employment_table">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="admin_family_message"></div>                                                
                                                    <div class="table-responsive">
                                                    <table id="mainTable2" class="table table-striped c_table">
                                                        ...
                                                        <tbody class="admin_family_table">
                                   ...
                                   <div class="container-fluid">
                                        <div class="row clearfix"> 
                                            ...
                                            <div class="col-lg-10 col-md-10">    
                                                ...
                                                @endphp
                                                <form method="post" action="{{route('admin.upload_personal_documents')}}" enctype="multipart/form-data">  
                                                @csrf   
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                            
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Id'])}}"> <span class="input-group-text" ><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Aadhar'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Pan'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Exp'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Salary'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Bank'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                ...
                                                <form method="post" action="{{route('admin.upload_academic_documents')}}" enctype="multipart/form-data">  
                                                @csrf  
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                        
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Sslc'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Puc'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Grad'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Pg'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Other'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('admin.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Course'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                   ...
                                   <div class="container-fluid">
                                        <div class="row clearfix"> 
                                            ...
                                            <div class="col-lg-10 col-md-10">     
                                                ...
                                                <form method="post" enctype="multipart/form-data" action="{{route('admin.career_objective')}}">  
                                                @csrf      
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                 
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                ...
                                                <form method="post" action="{{route('admin.user_other_activity')}}" enctype="multipart/form-data"> 
                                                @csrf    
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                   
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                ...
                                                <form method="post" action="{{route('admin.user_references')}}" enctype="multipart/form-data">  
                                                @csrf   
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                  
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6">
