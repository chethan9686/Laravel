        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>HR Policy</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{'user.dashboard'}}"><i class="zmdi zmdi-home"></i> HRM</a></li>
                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane in active" id="home_with_icon_title">
                                ...
                                <p>Going for meetings with clients from home directly is permissible for meetings before 11:30 am. Any meeting after 11:30 am would require employees to report to office by 9:30 am and then proceed for the meeting. Failure to do so will result in you being marked absent for the day.</p>
                                ...
                                <p>M.O.M. (Minutes of Meet) needs to be uploaded within 48 hours of completion of each meeting. Failure in uploading the same will result in you being marked absent for the day.</p>
