...
<title>HRM | Follow Up Meeting Request</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8">
                    <div class="card">  
                        <div class="header">
                            <h2><strong>Follow Up Meeting Form</strong></h2>
                        </div>                      
                        <div class="body">  
                            <form method="post" action="{{route('add_followup_meeting')}}" id="add_meeting" autocomplete="off">
                                @csrf
                                <input type="hidden" class="form-control" name="meeting_id" value="{{$Details->id}}">
                                <div class="row">                        
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group masked-input">
                                           ...
                                           <input type="text" class="form-control" name="company_name" placeholder="Enter Company Name" value="{{$Details->company_name}}" readonly="readonly">
                                        </div>    
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 client">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="client_name" placeholder="Client Name" value="{{$Details->client_name}}" readonly="readonly">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="client_email" placeholder="Client Email" value="{{$Details->client_email}}" readonly="readonly">
