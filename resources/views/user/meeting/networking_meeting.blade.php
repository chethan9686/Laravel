...
<title>HRM | Networking Meeting Request</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8">
                    <div class="card">  
                        <div class="header">
                            <h2><strong>Networking Meeting Form</strong></h2>
                        </div>                      
                        <div class="body">  
                            <form method="post" action="{{route('add_networking_meeting')}}" id="add_meeting">
                                @csrf
                                <div class="row">                        
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group gender-bottom"> 
                                            <div class="radio inlineblock m-r-20">                                                                    
                                                ...
                                                <label for="exist"><i class="zmdi zmdi-male"></i> Exist</label>
                                                <input type="radio" name="company" id="new" class="with-gap" value="new">
                                                <label for="new"><i class="zmdi zmdi-female"></i> New</label>
                                            </div>   
                                        </div>  
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div id="companyList" style="margin-top: -35px;"></div>                                      
                                        </span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="client_mobile" placeholder="Client Mobile Number">
