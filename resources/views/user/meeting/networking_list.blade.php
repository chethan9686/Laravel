...
<title>HRM | Networking Meeting List</title>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Networking Meeting List</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{'dashboard'}}"><i class="zmdi zmdi-home"></i> HRM</a></li>
                        <li class="breadcrumb-item">Networking Meeting</li>
                        <li class="breadcrumb-item active">Networking Meeting List</li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">          
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Networking</strong> Meeting List </h2>
                        </div>
                        <div class="body">
