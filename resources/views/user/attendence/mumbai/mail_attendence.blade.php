...
<title>:: Aero Bootstrap4 Admin :: Attendence</title>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Mumbai Mail Attendence</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Aero</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Tables</a></li>
                        <li class="breadcrumb-item active">Mumbai Mail Attendence</li>
                    </ul>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">                              
                            <form method="POST" action="{{route('mumb_send_mail')}}" role="form" enctype="multipart/form-data">
                            @csrf
                                <div class="row clearfix">
