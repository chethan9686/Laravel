...
<title>HRM | Mumbai Attendence</title>
                ...
                <div class="col-sm-12">
                    <div class="card"> 
                        <div class="header" style="padding-top: 0px;">
                            <button class="btn btn-info justify-content-center"><a style="color: white" onclick="tableToExcel('myTable', 'Mumbai Attendance', 'Mumbai Attendance.xls')">Download Mumbai Attendance </a></button>
                            @if(!is_null($LastMonth))
                                <a href="{{route('previous_mumb_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$LastMonth}} Attendence</button></a>
                            @else
                                <a href="{{route('mumb_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$Current->format('F')}} Attendence</button></a>
                            @endif
                        </div>
                        <div class="body">
...
<script>
    ...
    $('td.HD').css({"background-color":"#f00","color":"#fff","text-align":"center","min-width":"87px"});
...
<script type="text/javascript">
    ...
    $(document).on('blur', '.column_name', function(){
        ...
        swal({
            ...
            function() {                
            $.ajax({
                url:"{{ route('mumb_update_attendence') }}",
                method:"POST",
                dataType: "json",
