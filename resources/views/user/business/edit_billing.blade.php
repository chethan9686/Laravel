...
<title>Business Management | Edit Billing Information</title>
...
<section class="content">
    <div class="body_scroll">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                       <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Business Management</a></li>
                        ...
                        <li class="breadcrumb-item active">Edit Billing Info</li>
                    </ul>
        ...
        <div class="container-fluid">
            @php                                                                      
                $EncryptedId = \Illuminate\Support\Facades\Crypt::encrypt($Billing->id);                                                                                       
            @endphp
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <div class="card">  
                        ...
                        <div class="body">  
                            <form method="post" action="{{route('submit_edit_billing')}}" id="add_meeting" enctype="multipart/form-data">
                                @csrf
                               <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">                                       
                                        ...
                                        <label> <a  href="{{route('billing_download',[ 'EncryptedId' => $EncryptedId, 'EncryptedProof' => 'PO'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label> 
                                        <div class="input-group masked-input mb-3"> 
                                            <input type="file" id="dropify-event" name="purchase_file[]"  multiple="multiple" data-default-file="{{$Billing->purchase_file}}"> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <textarea class="form-control" name="po_address" id="po_address" rows="9" cols="50" placeholder="Type Altenate TO address for PO">{{ $Billing->po_address}}</textarea>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">                                       
                                        ...
                                        <label> <a  href="{{route('billing_download',[ 'EncryptedId' => $EncryptedId, 'EncryptedProof' => 'Client'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label> 
                                        <div class="input-group masked-input mb-3"> 
                                            <input type="file" id="dropify-event1" name="client_approval_file" data-default-file="{{asset('public/'.$Billing->client_approval_file)}}"> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">                                       
                                        ...
                                        <label> <a  href="{{route('billing_download',[ 'EncryptedId' => $EncryptedId, 'EncryptedProof' => 'FEI'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label> 
                                        <div class="input-group masked-input mb-3"> 
                                            <input type="file" id="dropify-event3" name="final_invoice_file" data-default-file="{{$Billing->final_invoice_file}}"> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        ...
                                        <div class="form-group gender-bottom"> 
                                            <div class="radio inlineblock m-r-20">                                                                    
                                                <input type="radio" name="company_status" id="exist" class="with-gap" value="exist"{{ $Billing->company_status == 'exist' ? 'checked' : ''}}>
                                                <label for="exist"><i class="zmdi zmdi-case-check"></i> Exist</label>
                                                <input type="radio" name="company_status" id="new" class="with-gap" value="new" {{ $Billing->company_status == 'new' ? 'checked' : ''}}>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12"  id="Certificate"<?php if($Billing->company_status == 'new') {?> <?php }else{?>  style="display: none" <?php }?> >    
                                        <label>Please Upload Company GST Certificate</label>
                                        <label> <a  href="{{route('billing_download',[ 'EncryptedId' => $EncryptedId, 'EncryptedProof' => 'GST'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label> 
                                        <div class="input-group masked-input mb-3"> 
                                            <input type="file" id="dropify-event4" name="gst_certificate" data-default-file="{{$Billing->gst_certificate}}"> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <textarea class="form-control" name="single_separate_billing" id="single_separate_billing" rows="9" cols="50" placeholder="Type Comment for single billing or separate billing for additional">{{ $Billing->single_separate_billing}}</textarea>
                                            @if ($errors->has('single_separate_billing'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('single_separate_billing') }}</strong>
                                                </span>
                                            @endif                                             
                                        </div>                                       
                                    </div>
