                                                ...
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <table class="p100" style="background-color: #150f13; margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 100%;" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#150f13">
                                                      ...
                                                      <tr>
                                                      <td style="font-weight: 700; letter-spacing: 0.03em; line-height: 23px; cursor: pointer;width: 600px;" align="center" valign="top" class="editable_text header3"><span style="color:#fff !important;font-family: arial, sans-serif;font-size:16px;">Out Of Station - Status</span></font>
                                                      </td>
                                                      </tr>
                                                      <tr>
                                                      <td style="font-size: 1px; height: 9px; line-height: 9px; mso-line-height-rule: exactly;" valign="top" align="left">&nbsp;</td>
                            ...
                            <tr>
                                <td align="center" valign="top" style="border-collapse: collapse;">
                                    <table class="p100" style="margin: 0;mso-table-lspace: 0;mso-table-rspace: 0;padding: 0;width: 500px;border-collapse: collapse;color: inherit;font-size: 16px;font-family: arial, sans-serif;" width="400" cellspacing="0" cellpadding="0" border="0" align="center">
                                        ...
                                        <tr>
                                            <div style="font-size:16x;height:13px;float:right;">
                                                <b>Date :</b> {{$today->format('d-m-Y')}}
                                            </div>
                                        </tr>
                                        <tr>
                                          <td style="font-size: 1px; height: 30px; line-height: 30px; mso-line-height-rule: exactly;" valign="top" align="center">&nbsp;</td>
                                        </tr>
                                        <p style="font-size:16px;text-align:justify;color: #222;font-size: 16px;font-family: arial, sans-serif;"><span style="font-weight:bold">Dear {{$User->first_name}},</span><span class="im">
                                            @if($OutStation->admin_status == "Rejected")
                                                 <p style="font-size:16px;text-align:justify">Your out of station <span style="text-transform: lowercase;">{{$OutStation->purpose_of_work}}</span> request has been <b>{{$OutStation->admin_comment}}</b>, kindly speak to HR for more information.</p>
                                            @else
                                                 <p style="font-size:16px;text-align:justify">Your out of station <span style="text-transform: lowercase;">{{$OutStation->purpose_of_work}}</span> request has been <b>{{$OutStation->admin_comment}},</b></p>
                                            @endif
                                        </tr>
                                        <tr>
                                            <td style="width: 500px;border-collapse: collapse;" width="500" align="center" valign="top">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="500" style="font-family: arial, sans-serif;border-collapse: collapse;width: 100%;color: inherit;font-size: 18px;">
                                                    <tr>
                                                        <td style="border: 1px solid #bbb8b8;color:#222;width: 200px;padding: 10px 20px 10px 20px;border-collapse: collapse;">Purpose Of Travel</td>
                                                        <td style="color:#222;border: 1px solid #bbb8b8;padding: 10px 20px 10px 20px;border-collapse: collapse;">{{$OutStation->event_name}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: 1px solid #bbb8b8;color:#222;width: 200px;padding: 10px 20px 10px 20px;border-collapse: collapse;">Location</td>
                                                        <td style="color:#222;border: 1px solid #bbb8b8;padding: 10px 20px 10px 20px;border-collapse: collapse;">{{$OutStation->event_location}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 20px 10px 20px;border: 1px solid #bbb8b8;color:#222;width: 200px;border-collapse: collapse;">Departure Date</td>
                                                        <td style="padding: 10px 20px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">
                                                            <?php echo date("d-m-Y",strtotime($OutStation->departure_date)) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">Departure Time</td>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;bbb8b8;border-collapse: collapse;"><?php echo date("h:i a",strtotime($OutStation->departure_time)) ?></td>
                                                    </tr>                                                    
                                                    <tr>
                                                        <td style="padding: 10px 20px 10px 20px;border: 1px solid #bbb8b8;color:#222;width: 200px;border-collapse: collapse;">Arrival Date</td>
                                                        <td style="padding: 10px 20px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">
                                                            <?php echo date("d-m-Y",strtotime($OutStation->arrival_date)) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">Arrival Time</td>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;bbb8b8;border-collapse: collapse;"><?php echo date("h:i a",strtotime($OutStation->arrival_time)) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: 1px solid #bbb8b8;color:#222;width: 200px;padding: 10px 20px 10px 20px;border-collapse: collapse;">Mode Of Travel</td>
                                                        <td style="color:#222;border: 1px solid #bbb8b8;padding: 10px 20px 10px 20px;border-collapse: collapse;">{{$OutStation->travel_mode}}</td>
                                                    </tr>   
                                                    <tr>
                                                        <td style="border: 1px solid #bbb8b8;color:#222;width: 200px;padding: 10px 20px 10px 20px;border-collapse: collapse;">Status</td>
                                                        <td style="color:#222;border: 1px solid #bbb8b8;padding: 10px 20px 10px 20px;border-collapse: collapse;"><b>{{$OutStation->admin_status}}</b></td>
                                                    </tr>     
                                                </table>
                                            </td>
                                        </tr>
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse;">
            <table class="p100" style="background-color: #fff;margin: 0;mso-table-lspace: 0;mso-table-rspace: 0;padding: 0;width: 800px;border-collapse: collapse;color: inherit;font-size: 16px;font-family: arial, sans-serif;" width="800" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff">
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse;">
                        <table class="p100" style="margin: 0;mso-table-lspace: 0;mso-table-rspace: 0;padding: 0;width: 600px;border-collapse: collapse;color: inherit;font-size: 16px;font-family: arial, sans-serif;" width="500" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td style="width: 30px;font-size: 1px;border-collapse: collapse;" width="30" valign="top" align="left">&nbsp;</td>
                                <td align="center" valign="top" style="border-collapse: collapse;">                                   
                                    <table style="margin: 0;mso-table-lspace: 0;mso-table-rspace: 0;padding: 0;border-collapse: collapse;color: inherit;font-size: 16px;font-family: arial, sans-serif;" cellspacing="0" cellpadding="0" border="0" align="center">
                                         <p style="font-size: 16px;text-align:justify;color: #222222;"><b>Regards,<br></b></p>
                                            ...
                                            <td align="left" valign="top" style="border-collapse: collapse;">
                                                <table style="margin: 0;mso-table-lspace: 0;mso-table-rspace: 0;padding: 0;border-collapse: collapse;color: inherit;font-size: 16px;font-family: arial, sans-serif;" cellspacing="0" cellpadding="0" border="0" align="center"  width="500">
                                                    <tr>
