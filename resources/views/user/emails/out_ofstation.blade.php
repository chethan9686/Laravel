                                                ...
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <table class="p100" style="background-color: #150f13; margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 100%;" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#150f13">
                                                      ...
                                                      <tr>
                                                      <td style="font-weight: 700; letter-spacing: 0.03em; line-height: 23px; cursor: pointer;width: 600px;" align="center" valign="top" class="editable_text header3"><span style="color:#fff !important;font-family: arial, sans-serif;font-size:16px;">Out Of Station Request</span>
                                                      </td>
                                                      </tr>
                                                      <tr>
                                                      <td style="font-size: 1px; height: 9px; line-height: 9px; mso-line-height-rule: exactly;" valign="top" align="left">&nbsp;</td>
                            ...
                            <tr>
                                <td align="center" valign="top" style="border-collapse: collapse;">
                                    <table class="p100" style="margin: 0;mso-table-lspace: 0;mso-table-rspace: 0;padding: 0;width: 500px;border-collapse: collapse;color: inherit;font-size: 16px;font-family: arial, sans-serif;" width="400" cellspacing="0" cellpadding="0" border="0" align="center">
                                        ...
                                        <tr>
                                            <div style="font-size:16px;height:13px;float:right;">
                                        ...
                                        <p style="font-size:16px;text-align:justify;color: #222;"><span style="font-weight:bold">Dear Sir/Madam,</span></p><span class="im">
                                        <p style="font-size:16px;text-align:justify">Please find below, the out of station <b style="text-transform: lowercase;">{{ $Latest->purpose_of_work}}</b> details. I request you to kindly approve the same.</p>
                                        </tr>
                                        <tr>
                                            <td style="width: 500px;border-collapse: collapse;" width="500" align="center" valign="top">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="500" style="font-family: arial, sans-serif;border-collapse: collapse;width: 100%;color: inherit;font-size: 18px;">
                                                    <tr>
                                                        ...
                                                        <td style="color:#222;border: 1px solid #bbb8b8;padding: 10px 20px 10px 20px;border-collapse: collapse;">{{$Latest->event_name}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: 1px solid #bbb8b8;color:#222;width: 200px;padding: 10px 20px 10px 20px;border-collapse: collapse;">Location</td>
                                                        <td style="color:#222;border: 1px solid #bbb8b8;padding: 10px 20px 10px 20px;border-collapse: collapse;">{{$Latest->event_location}}</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="padding: 10px 20px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">
                                                            <?php echo date("d-m-Y",strtotime($Latest->departure_date)) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">Departure Time</td>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;bbb8b8;border-collapse: collapse;"><?php echo date("h:i a",strtotime($Latest->departure_time)) ?></td>
                                                    </tr>                                                    
                                                    <tr>
                                                        ...
                                                        <td style="padding: 10px 20px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">
                                                            <?php echo date("d-m-Y",strtotime($Latest->arrival_date)) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;border-collapse: collapse;">Arrival Time</td>
                                                        <td style="padding: 10px 10px 10px 20px;border: 1px solid #bbb8b8;color:#222;bbb8b8;border-collapse: collapse;"><?php echo date("h:i a",strtotime($Latest->arrival_time)) ?></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="color:#222;border: 1px solid #bbb8b8;padding: 10px 20px 10px 20px;border-collapse: collapse;">{{$Latest->travel_mode}}</td>
                                                    </tr>     
                                                </table>
                                            </td>
                                        </tr>
