    ...
    <div class="body_scroll">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Recce</li>
                    </ul>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10">
                    <div class="card">
                       <div class="header">
                          <h2> <strong>Event-Recce</strong> Entry</h2>
                       </div>
                       <div class="body">                              
                            <form method="POST" action="{{ route('reccecreate')}}" id="reccecreate" enctype="multipart/form-data" autocomplete="off">
                            {{csrf_field()}}
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="recce_clientname" id="recce_clientname"  autocomplete="off" placeholder="Client Name">
                                            @if ($errors->has('recce_clientname'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('recce_clientname') }}</strong>
                                                </span>
                                            @endif 
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="recce_eventname" id="recce_eventname"  autocomplete="off" placeholder="Event Name">
                                            @if ($errors->has('recce_eventname'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('recce_eventname') }}</strong>
                                                </span>
                                            @endif 
                                        </div>
                                    </div>
                                     <div class="col-lg-4 col-md-4">
                                        <label>Recce Date </label>
                                        <div class="input-group masked-input mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="zmdi zmdi-calendar-note"></i></span>
                                            </div>
                                            <input type="text"  id="date" class="form-control" name="recce_dateofrecce" id="recce_dateofrecce" autocomplete="off" placeholder="Date of Recce">
                                            @if ($errors->has('recce_dateofrecce'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('recce_dateofrecce') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                     <div class="col-lg-4 col-md-4">
                                        <label>Recce Time</label>
                                        <div class="input-group masked-input mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="zmdi zmdi-timer"></i></span>
                                            </div>
                                            <input type="text" class="form-control calendar" name="recce_time" id="recce_time" autocomplete="off" placeholder="Time of Recce" onkeydown="return false">
                                             @if ($errors->has('recce_time'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('recce_time') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <label>Recce Location</label>
                                        <div class="input-group masked-input mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="zmdi zmdi-google-maps"></i></span>
                                            </div>
                                            <input type="text" class="form-control" name="recce_eventlcation" id="recce_eventlcation" autocomplete="off" placeholder="Recce Location">
                                            @if ($errors->has('recce_eventlcation'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('recce_eventlcation') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="recce_eventenddate" id="eventdate" autocomplete="off" placeholder="Scheduled Event Date">
                                            @if ($errors->has('recce_eventenddate'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('recce_eventenddate') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" id="time" name="recce_ERTW" autocomplete="off" placeholder="Expected Time Back To Office">
                                            @if ($errors->has('recce_ERTW'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('recce_ERTW') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <select class="form-control show-tick ms select2" multiple data-placeholder="Tag Team Member" name="recce_references_id[]">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Export</strong> Recce </h2>
                    </div>
                    <div class="body">
...
<script>
    ...
    $("#reccecreate").on("submit", function(){
        $("#pageloader").fadeIn();
    });//submit
</script>
{!! Toastr::message() !!}
