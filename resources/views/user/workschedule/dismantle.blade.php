    ...
    <div class="body_scroll">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Dismantle</li>
                    </ul>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10">
                    <div class="card">
                       <div class="header">
                          <h2> <strong>Dismantle</strong> Entry</h2>
                       </div>
                       <div class="body">                              
                            <form method="POST" action="{{ route('dismantlecreate')}}" id="dismantlecreate" enctype="multipart/form-data" autocomplete="off">
                            {{csrf_field()}}
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="dis_clientname" id="dis_clientname"  autocomplete="off" placeholder="Client Name">
                                            @if ($errors->has('dis_clientname'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('dis_clientname') }}</strong>
                                                </span>
                                            @endif 
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="dis_eventname" id="dis_eventname"  autocomplete="off" placeholder="Event Name">
                                            @if ($errors->has('dis_eventname'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('dis_eventname') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                     <div class="col-lg-4 col-md-4">
                                        <label>Date Of Dismantle</label>
                                        <div class="input-group masked-input mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="zmdi zmdi-calendar-note"></i></span>
                                            </div>
                                            <input type="text"  id="date" class="form-control date" name="dis_dateofdismantle" id="dis_dateofdismantle" autocomplete="off" placeholder="Date Of Dismantle">
                                            @if ($errors->has('dis_dateofdismantle'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('dis_dateofdismantle') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <label>Dismantle Start Time</label>
                                        <div class="input-group masked-input mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="zmdi zmdi-timer"></i></span>
                                            </div>
                                            <input type="text" class="form-control" id="time" name="dis_time" autocomplete="off" placeholder="Dismantle Start Time">
                                            @if ($errors->has('dis_time'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('dis_time') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="dis_location" id="dis_location" autocomplete="off" placeholder="Location">
                                            @if ($errors->has('dis_location'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('dis_location') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">                                           
                                            <select class="form-control show-tick " data-placeholder="Select" name="dis_EWH">
                                            ...
                                            @if ($errors->has('dis_EWH'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('dis_EWH') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <select class="form-control show-tick ms select2" multiple data-placeholder="Tag Team Member" name="dis_references_id[]">
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Client Name</th>
                                        <th>Event Name</th>
                                        <th>Date Of Dismantle</th>
                                        <th>Dismantle Start Time</th>
                                        <th>Location</th>
                                ...
                                <tbody>
                                    @foreach($Dismentalid as $key=>$data)
                                         @php                                            
                                           $user = \App\User::find($data->user_id);
                                           $branch = \App\Branch::find($data->branch);                                           
                                          @endphp
                                         <?php
                                      if($data->dis_references_id != 0){
                                        $tag_users = \App\Dismental::where('dis_references_id','=',$data->dis_references_id)->where('user_id','!=',$user->id)->orwhere('id','=',$data->dis_references_id)->get();
                                        foreach($tag_users as $key1=>$tag){
                                                $users = \App\User::find($tag->user_id);                                               
                                                $Res[$key1] = $users->first_name;
                                            }  
                                        }else{
                                               $tag_users = \App\Dismental::where('dis_references_id','=',$data->id)->get();
                                        foreach($tag_users as $key1=>$tag){
                                                $users = \App\User::find($tag->user_id);                                               
                                                $Res[$key1] = $users->first_name;
                                            }   
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td>{{$branch->name}}</td>
                                            <td>{{$data->dis_clientname}}</td>
                                            <td>{{$data->dis_eventname}}</td>
                                            <td><?php echo date('d-m-Y', strtotime($data->dis_dateofdismantle)) ?></td>
                                            <td><?php echo date("h:i A",strtotime($data->dis_time)) ?></td>
                                            <td>{{$data->dis_location}}</td>
                                            <td><?php echo date("h:i A",strtotime($data->dis_EWH)) ?></td>
...
<script>
    ...
    $("#dismantlecreate").on("submit", function(){
        $("#pageloader").fadeIn();
    });//submit
</script>
{!! Toastr::message() !!}
