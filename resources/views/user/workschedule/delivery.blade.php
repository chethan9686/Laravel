    ...
    <div class="body_scroll">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10">
                    <div class="card">
                       <div class="header">
                          <h2> <strong>Delivery</strong> Entry</h2>
                       </div>
                       <div class="body">                              
                            <form method="POST" action="{{ route('deliverycreate')}}" id="deliverycreate" enctype="multipart/form-data" autocomplete="off">
                            {{csrf_field()}}
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="delry_clientname" id="delry_clientname"  autocomplete="off" placeholder="Client Name">
                                            @if ($errors->has('delry_clientname'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('delry_clientname') }}</strong>
                                                </span>
                                            @endif 
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control" name="delry_lcation" id="delry_lcation"  autocomplete="off" placeholder="Delivery Location">
                                            @if ($errors->has('delry_lcation'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('delry_lcation') }}</strong>
                                                </span>
                                            @endif 
                                        </div>
                                    </div>
                                     <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text"  id="date" class="form-control" name="delry_dateofdelivery" id="delry_dateofdelivery" autocomplete="off" placeholder="Date of Delivery">
                                            @if ($errors->has('delry_dateofdelivery'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('delry_dateofdelivery') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                     <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control calendar" name="delry_time" id="delry_time" autocomplete="off" placeholder="Time of Delivery" onkeydown="return false">
                                            @if ($errors->has('delry_time'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('delry_time') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" class="form-control time" id="delry_ERTW" name="delry_ERTW" autocomplete="off" placeholder="Expected Time Back To Office">
                                            @if ($errors->has('delry_ERTW'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('delry_ERTW') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <select class="form-control show-tick ms select2" multiple data-placeholder="Tag Team Member" name="delivery_references_id[]">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label>Purpose Of Delivery</label>
                                        <div class="input-group masked-input mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="zmdi zmdi-assignment"></i></span>
                                            </div>
                                           <textarea class="form-control" name="purposeofdelivery" id="purposeofdelivery" rows="4" cols="50" placeholder="Type Purpose of Delivery.."></textarea>
                                           @if ($errors->has('purposeofdelivery'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('purposeofdelivery') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                           ...
                                           <textarea class="form-control" name="itemdescription" id="itemdescription" rows="4" cols="50" placeholder="Type Item Description.."></textarea>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Export</strong> DELIVERY</h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody> 
                                     @foreach($Deliveryid as $key=>$data)
                                        @php                                            
                                           $user = \App\User::find($data->user_id);
                                           $branch = \App\Branch::find($data->branch);                                           
                                        @endphp
                                        <?php
                                              if($data->delivery_references_id != 0){
                                                $tag_users = \App\Delivery::where('delivery_references_id','=',$data->delivery_references_id)->where('user_id','!=',$user->id)->orwhere('id','=',$data->delivery_references_id)->get();
                                                foreach($tag_users as $key1=>$tag){
                                                        $users = \App\User::find($tag->user_id);                                               
                                                        $Res[$key1] = $users->first_name;
                                                    }  
                                                }else{
                                                       $tag_users = \App\Delivery::where('delivery_references_id','=',$data->id)->get();
                                                foreach($tag_users as $key1=>$tag){
                                                        $users = \App\User::find($tag->user_id);                                               
                                                        $Res[$key1] = $users->first_name;
                                                    }   
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$branch->name}}</td>
                                            <td>{{$data->delry_clientname}}</td>
                                            <td>{{$data->delry_lcation}}</td>
                                            <td><?php echo date('d-m-Y', strtotime($data->delry_dateofdelivery)) ?></td>
                                            <td><?php echo date("h:i A",strtotime($data->delry_time)) ?></td>
                                            <td>{{$data->purposeofdelivery}}</td>
                                            <td>{{$data->itemdescription}}</td>
                                            <td><?php echo date("h:i A",strtotime($data->delry_ERTW)) ?></td>
...
<script>
    ...
    $("#deliverycreate").on("submit", function(){
        $("#pageloader").fadeIn();
    });//submit
</script>
{!! Toastr::message() !!}
