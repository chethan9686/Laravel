...
<title>HRM | View Appriciation Mailer</title>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Appreciation Mailer</li>
                    </ul>
                ...
                <div class="card">
                  <div class="header">
                   ...
                   <div class="chat_window body">
                        ...
                        <form method="POST" action="{{ route('hr.appriciation_wish') }}" id="appriciationwishesh">
                          {{ csrf_field() }}                       
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        @forelse($maildata as $data)
                          ...
                          @endphp
                            <li><a href="{{ route('hr.view_appriciation',[ 'EncryptedId' => $EncryptedId ])}}">{{ $data->eventname}}</a></li>
                        @empty
                          <li>No Data</li>
                        @endforelse
                        </ul>
