...
<title>HRM | Post New Appreciation</title>
...
<section class="content">
    <div class="body_scroll">
          ...
          <div class="row">
              <div class="col-lg-7 col-md-6 col-sm-12">
                  ...
                  <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Appreciation</li>
                        <li class="breadcrumb-item active">Post New Appreciation</li>
                  </ul>
      ...
      <div class="container-fluid">
          <form method="POST" action="{{ route('hr.appriciation_form') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
           {{ csrf_field() }}
                  ...
                  <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                    ...
                    <tbody>                      
                      ...
                      @php
                        ...
                        $eventdate1 = \Carbon\Carbon::parse($mails->eventdate);    
                        $eventdate = $eventdate1->format('l jS F Y'); 
                      @endphp
                        <tr class="text-center-row">
                          <td>{{ $key+1 }}</td>
                          ...
                          <td>{{ $eventdate1->format('Y-m-d') }}</td>
                          <td>{{ $mails->location }}</td>
                          <td>
                            <a href="{{ route('hr.view_appriciation',[ 'EncryptedId' => $EncryptedId ])}}">
                              <button type="button" class="btn btn-raised m-b-10 btn-info waves-effect" data-placement-from="bottom" data-placement-align="left" data-color-name="alert-info"><i class="zmdi zmdi-eye"></i></button>
                            </a>
                              <button type="button" class="btn btn-raised m-b-10 bg-teal waves-effect" data-toggle="modal" data-target="#largeModal{{$mails->id}}" data-placement-from="bottom" data-placement-align="right" data-color-name="bg-teal"><i class="zmdi zmdi-edit"></i></button>
                          </td>
                          <td>
                            <button type="button" class="btn btn-raised m-b-10 bg-red waves-effect" data-id="{{ $mails->id }}" data-toggle="modal" data-target="#deleteapp" data-placement-from="bottom" data-placement-align="left" data-color-name="bg-red"><i class="zmdi zmdi-delete"></i></button>
                          </td>
                        </tr>  
                          ...
                          <div class="modal fade" id="largeModal{{$mails->id}}" tabindex="-1" role="dialog">
                              <div class="modal-dialog modal-lg" role="document">
                                  <div class="modal-content">
                                      ...
                                      <form method="POST" action="{{ route('hr.update_appriciation') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                                      @csrf
    ...
    <div class="modal fade" id="deleteapp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('hr.appreciation_delete') }}" method="post">
                  {{csrf_field()}}
                  <div class="modal-body"> 
