  <script type="text/javascript">
    ...
    {
         var user_id = <?php echo json_encode(\Illuminate\Support\Facades\Request::segment(2)); ?>;          
         ...
         $(document).on('click', '#add', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.add_academic_data') }}",
            method:"POST",
          ...
          {    
           $('#hr_message').html("<div class='alert alert-danger'>All Fields are required</div>");
          }
         });
         ...
         $(document).on('blur', '.column_name', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.update_academic_data') }}",
            method:"POST",
          ...
          {
           $('#hr_message').html("<div class='alert alert-danger'>Enter some value</div>");
          }
         });
         ...
         $(document).on('click', '.delete', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.delete_academic_data') }}",
            method:"POST",
         ...
         $(document).on('click', '#emp_add', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.add_employment_data') }}",
            method:"POST",
          ...
          {    
           $('#hr_emp_message').html("<div class='alert alert-danger'>All Employment Details Fields are required</div>");
          }
         });
         ...
         $(document).on('blur', '.employment_name', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.update_employment_data') }}",
            method:"POST",
            data:{column_name:column_name, column_value:column_value, id:id, _token:_token},
            success:function(data)
            {
          ...
          {
           $('#hr_emp_message').html("<div class='alert alert-danger'>Enter some value</div>");
          }
         });
         ...
         $(document).on('click', '.emp_delete', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.delete_employment_data') }}",
            method:"POST",
            data:{id:id, _token:_token},
            success:function(data)
            {
         ...
         $(document).on('click', '#family_add', function(){
          ...
          {    
           $('#hr_family_message').html("<div class='alert alert-danger'>All Family Details Fields are required</div>");
          }
         });
         ...
         $(document).on('blur', '.family_name', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.update_family_data') }}",
            method:"POST",
            data:{column_name:column_name, column_value:column_value, id:id, _token:_token},
            success:function(data)
            {
          ...
          {
           $('#hr_family_message').html("<div class='alert alert-danger'>Enter some value</div>");
          }
         });
         ...
         $(document).on('click', '.family_delete', function(){
          ...
          {
           $.ajax({
            url:"{{ route('hr.delete_family_data') }}",
            method:"POST",
            data:{id:id, _token:_token},
            success:function(data)
            {
