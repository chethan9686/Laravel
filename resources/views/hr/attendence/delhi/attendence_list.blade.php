                    ...
                    <div class="card"> 
                        <div class="header" style="padding-top: 0px;">
                            ...
                            @if(!is_null($LastMonth))
                                <a href="{{route('hr.delhi_previous_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$LastMonth}} Attendence</button></a>
                            @else
                                <a href="{{route('hr.del_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$Current->format('F')}} Attendence</button></a>
                            @endif
                        </div>   
                        <div class="body">
