...
<title>HRM | Attendence Sheet Upload</title>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Upload Attendence Sheet</li>
                    </ul>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                       ...
                       <div class="body">                              
                            <form method="POST" action="{{route('hr.upload_punch_in_details')}}" role="form" enctype="multipart/form-data">
                            @csrf
                                <div class="row clearfix">
