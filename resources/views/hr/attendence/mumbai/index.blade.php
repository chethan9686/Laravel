...
<title>HRM | Mumbai Attendence Sheet Upload</title>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Mumbai Attendence</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{'dashboard'}}"><i class="zmdi zmdi-home"></i> HRM</a></li>
                        <li class="breadcrumb-item active">Mumbai Attendence</li>
                    </ul>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                       ...
                       <div class="body">                              
                            <form method="POST" action="{{route('hr.mum_upload_punch_in_details')}}" role="form" enctype="multipart/form-data">
                            @csrf
                                <div class="row clearfix">
