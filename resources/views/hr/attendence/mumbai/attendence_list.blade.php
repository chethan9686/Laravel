...
<title>HRM | Mumbai Monthly Attendence List</title>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Mumbai {{$today->format('F')}} Attendence</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{'dashboard'}}"><i class="zmdi zmdi-home"></i> HRM</a></li>
                        <li class="breadcrumb-item active">{{$today->format('F')}} Attendence</li>
                    </ul>
                    ...
                    <div class="card"> 
                        <div class="header" style="padding-top: 0px;">
                            ...
                            @if(!is_null($LastMonth))
                                <a href="{{route('hr.mumbai_previous_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$LastMonth}} Attendence</button></a>
                            @else
                                <a href="{{route('hr.mum_attendence_list')}}"><button type="button" class="btn btn-primary" style="float: right;">{{$Current->format('F')}} Attendence</button></a>
                            @endif
                        </div> 
                        <div class="body">
