...
<title>HRM | Employee Profile</title>
                    ...
                    <div class="card">                        
                        <div class="body">                          
                            ...
                            <ul class="nav nav-tabs p-0 mb-3 nav-tabs-success" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#official"><i class="zmdi zmdi-memory"></i> Official Documents </a></li>
                            </ul>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row clearfix">                                 
                                            ...
                                            <div class="col-lg-10 col-md-10">                                               
                                                <form method="post" action="{{route('hr.update_basic_details')}}" enctype="multipart/form-data">
                                                    @csrf
                                                        ...
                                                        <div class="col-lg-4 col-md-4">
                                                            ...
                                                            <div class="form-group">                                                       
                                                                <select class="form-control show-tick" data-placeholder="Select" name="regional_head">
                                                                    <option value="">Regional Head</option>                                                                  
                                                                    @foreach($rhs as $rh)
                                                                        @if($rh->id != $user_details->rh)
                                                                            <option value="{{$rh->id}}">{{$rh->first_name}} {{$rh->last_name}}</option>
                                                                        @else
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Designation" name="designation" value="{{$user_details->designation}}">
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="col-lg-10 col-md-10">                                                                             
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <form method="post" action="{{route('hr.update_passport_details')}}" enctype="multipart/form-data">
                                                            @csrf         
                                                            <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                           
                                                                <div class="card">                                                           
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <form method="post" action="{{route('hr.update_bank_details')}}" enctype="multipart/form-data">
                                                            @csrf       
                                                            <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                 
                                                                <div class="card">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row clearfix"> 
                                            ...
                                            <div class="col-lg-10 col-md-10">
                                                ...
                                                <form method="post" action="{{route('hr.update_pf_form')}}" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <table id="mainTable" class="table table-striped c_table">
                                                        ...
                                                        <tbody class="hr_education_table">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <table id="mainTable1" class="table table-striped c_table">
                                                        ...
                                                        <tbody class="hr_employment_table">
                                   ...
                                   <div class="container-fluid">
                                        <div class="row clearfix"> 
                                            ...
                                            <div class="col-lg-10 col-md-10">    
                                                ...
                                                @endphp
                                                <form method="post" action="{{route('hr.upload_personal_documents')}}" enctype="multipart/form-data">  
                                                @csrf   
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                            
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Id'])}}"> <span class="input-group-text" ><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Aadhar'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Pan'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Exp'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Salary'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Bank'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                ...
                                                <form method="post" action="{{route('hr.upload_academic_documents')}}" enctype="multipart/form-data">  
                                                @csrf  
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                        
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Sslc'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Puc'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"> <a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Grad'])}}"><span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            <label for="email_address">Post-Graduate Certificate</label>
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Pg'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                       <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Other'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="card">
                                                            ...
                                                            <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Course'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                            <div class="form-group">                                                       
                                   ...
                                   <div class="container-fluid">
                                        <div class="row clearfix"> 
                                            ...
                                            <div class="col-lg-10 col-md-10">     
                                                ...
                                                <form method="post" enctype="multipart/form-data" action="{{route('hr.career_objective')}}">  
                                                @csrf      
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                 
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                ...
                                                <form method="post" action="{{route('hr.user_other_activity')}}" enctype="multipart/form-data"> 
                                                @csrf    
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                   
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4">
                                                ...
                                                <form method="post" action="{{route('hr.user_references')}}" enctype="multipart/form-data">  
                                                @csrf   
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                                  
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6">
                                 ...
                                 <div role="tabpanel" class="tab-pane" id="official">
                                    <div class="container-fluid">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10">    
                                                <div class="header">
                                                    <h2 class="text-center"><strong>OFFICIAL</strong> DOCUMENTS</h2>
                                                </div>   
                                                @php
                                                    $EncryptedId = \Illuminate\Support\Facades\Crypt::encrypt($user->id);
                                                @endphp
                                                <form method="post" action="{{route('hr.upload_official_documents')}}" enctype="multipart/form-data">  
                                                @csrf   
                                                <input type="hidden" name="user_id" value="{{$EncryptedUserID}}">                                                            
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3">
                                                            <div class="card">
                                                                <label for="email_address">KRA</label>
                                                                <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'KRA'])}}"> <span class="input-group-text" ><i class="zmdi zmdi-download"></i></span></a></label>
                                                                <div class="form-group">                                                       
                                                                   <input type="file" class="dropify" data-height="120" multiple="multiple" data-allowed-file-extensions="*" name="kra[]"
                                                                   data-default-file="{{asset('public/'.$kra)}}">
                                                                </div>
                                                            </div>  
                                                        </div>    
                                                        <div class="col-lg-3 col-md-3">
                                                           <div class="card">
                                                                <label for="email_address">Commitment Letter</label>
                                                                <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'commitment'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                                <div class="form-group">                                                       
                                                                   <input type="file" class="dropify" data-height="120" multiple="multiple" data-allowed-file-extensions="*" name="commitment[]"
                                                                   data-default-file="{{asset('public/'.$commitment)}}">
                                                                </div>
                                                            </div>
                                                        </div> 
                                                        <div class="col-lg-3 col-md-3">
                                                           <div class="card">
                                                                <label for="email_address">Offer Letter</label>
                                                                <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Offer_Letter'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                                <div class="form-group">                                                       
                                                                   <input type="file" class="dropify" data-height="120" multiple="multiple" data-allowed-file-extensions="*" name="offer_letter[]"
                                                                   data-default-file="{{asset('public/'.$offer_letter)}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3">
                                                            <div class="card">
                                                                <label for="email_address">Yearly Appraisal</label>
                                                                <label  class="download"><a  href="{{ route('hr.download',[ 'EncryptedId' => $EncryptedId , 'EncryptedProof' => 'Yearly_Appraisal'])}}"> <span class="input-group-text"><i class="zmdi zmdi-download"></i></span></a></label>
                                                                <div class="form-group">                                                      
                                                                   <input type="file" class="dropify" data-height="120" multiple="multiple" data-allowed-file-extensions="*" name="yearly_appraisal[]"
                                                                   data-default-file="{{asset('public/'.$yearly_appraisal)}}">
                                                                </div>
                                                            </div>  
                                                        </div>
                                                    </div> 
