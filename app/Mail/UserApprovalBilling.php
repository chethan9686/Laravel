...
class UserApprovalBilling extends Mailable
{
    ...
    public function build()
    {
        ...
        if(empty($this->CC))
        {
        $Result = $this->markdown('user.emails.business.user_approvalbilling')  
            ...
            ->subject($this->SignupUser->first_name.' '.$this->SignupUser->last_name.' - '."Approval Billing");
