...
class UserCancelBilling extends Mailable
{
    ...
    {
        return $this->markdown('user.emails.business.user_cancel_billing')  
            ...
            ->cc($this->CC) 
            ->subject($this->SignupUser->first_name.' '.$this->SignupUser->last_name.' - '."Cancelled Billing");
    }
}
