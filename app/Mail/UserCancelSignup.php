...
class UserCancelSignup extends Mailable
{
    ...
    {
        return $this->markdown('user.emails.business.user_cancel_signup')  
            ...
            ->cc($this->CC) 
            ->subject($this->SignupUser->first_name.' '.$this->SignupUser->last_name.' - '."Cancelled Signup");
    }
}
