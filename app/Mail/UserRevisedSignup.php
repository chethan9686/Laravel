...
class UserRevisedSignup extends Mailable
{
    ...
    public function build()
    {
        ...
        {
            return $this->markdown('user.emails.business.user_revised_signup')  
            ...
            ->subject($this->SignupUser->first_name.' '.$this->SignupUser->last_name.' - '."Revised Approval Signup");
        }
        else
        {
            return $this->markdown('user.emails.business.user_revised_signup')  
