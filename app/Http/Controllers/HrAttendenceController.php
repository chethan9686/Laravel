...
class HrAttendenceController extends Controller
{
    public function attendence()
    {      
        return view('hr.attendence.bangalore.index');
    }   
    ...
    public function attendencelist()
    {
        ...
        {           
            $this->calculate_bang_attendence($data->id);
        }

        $users = BangaloreAttendence::where('year','=',$today->year)->where('month','=',$today->month)->distinct()->select($dates)->orderBy('emp_name','ASC')->get();
       
        return view('hr.attendence.bangalore.attendence_list',compact('users','calendar','Current','LastMonth'));
    }
    ...
    public function calculate_bang_attendence($data)
    {        
