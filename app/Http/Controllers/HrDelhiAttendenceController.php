...
class HrDelhiAttendenceController extends Controller
{
    public function attendence()
    {      
        return view('hr.attendence.delhi.index');
    }   
    ...
    public function attendencelist()
    {
        ...
        {           
            $this->calculate_delhi_attendence($data->id);
        }

        $users = DelhiAttendence::where('year','=',$today->year)->where('month','=',$today->month)->distinct()->select($dates)->orderBy('emp_name','ASC')->get();        

        return view('hr.attendence.delhi.attendence_list',compact('users','calendar','Current','LastMonth'));
    }
    ...
    public function calculate_delhi_attendence($data)
    {        
